...
public interface FeedsServiceRep{
    ...
    long postMessage(@PathParam(USER) String user, @QueryParam(PWD) String pwd, Message msg, @HeaderParam(HEADER_VERSION) Long version);
    ...
    @DELETE
    @Path("/{" + USER + "}/{" + MID + "}")
    void removeFromPersonalFeed(@PathParam(USER) String user, @PathParam(MID) long mid, @QueryParam(PWD) String pwd, @HeaderParam(HEADER_VERSION) Long version);
    ...
    @Path("/{" + USER + "}/{" + MID + "}")
    @Produces(MediaType.APPLICATION_JSON)
    Message getMessage(@PathParam(USER) String user, @PathParam(MID) long mid, @HeaderParam(HEADER_VERSION) Long version);
    ...
    @Path("/{" + USER +"}")
    @Produces(MediaType.APPLICATION_JSON)
    List<Message> getMessages(@PathParam(USER) String user, @QueryParam(TIME) long time, @HeaderParam(HEADER_VERSION) Long version);
    ...
    void subUser(@PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd, @HeaderParam(HEADER_VERSION) Long version);
    ...
    @DELETE
    @Path("/sub/{" + USER + "}/{" + USERSUB + "}")
    void unsubscribeUser(@PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd, @HeaderParam(HEADER_VERSION) Long version);
    ...
    @DELETE
    @Path("/personal/{" + USER + "}")
    void deleteUserFeed(@PathParam(USER) String user, @HeaderParam(HEADER_VERSION) Long version);
}
